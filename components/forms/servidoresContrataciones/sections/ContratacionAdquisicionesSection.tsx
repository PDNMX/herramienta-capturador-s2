...
// Tipos de Área según PDF página 2-3
const tiposArea = [
...
// Niveles de Responsabilidad según PDF página 2-3
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <div className="space-y-6 p-6 rounded-lg border-2 border-primary/20 bg-card/50">
          ...
          <FormField
            control={form.control}
            name="contratacionAdquisiciones.0.numeroExpediente"
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-sm font-semibold">
                ...
                <FormDescription className="text-xs text-muted-foreground">
                  Número de expediente o folio del procedimiento
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <FormField
              control={form.control}
              name="contratacionAdquisiciones.0.tipoProcedimiento"
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-sm font-semibold">
            ...
            <FormField
              control={form.control}
              name="contratacionAdquisiciones.0.materia"
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-sm font-semibold">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <FormField
              control={form.control}
              name="contratacionAdquisiciones.0.fechaInicio"
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-sm font-semibold">
            ...
            <FormField
              control={form.control}
              name="contratacionAdquisiciones.0.fechaConclusion"
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-sm font-semibold">
          ...
          <div className="p-4 bg-blue-50/50 dark:bg-blue-900/20 rounded-lg border border-blue-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <FormField
                control={form.control}
                name="contratacionAdquisiciones.0.razonSocial"
                render={({ field }) => (
                  <FormItem>
              ...
              <FormField
                control={form.control}
                name="contratacionAdquisiciones.0.nombreBeneficiario"
                render={({ field }) => (
                  <FormItem>
              ...
              <FormField
                control={form.control}
                name="contratacionAdquisiciones.0.primerApellidoBeneficiario"
                render={({ field }) => (
                  <FormItem>
              ...
              <FormField
                control={form.control}
                name="contratacionAdquisiciones.0.segundoApellidoBeneficiario"
                render={({ field }) => (
                  <FormItem>
          ...
          <FormField
            control={form.control}
            name="contratacionAdquisiciones.0.continuaParticipando"
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-sm font-semibold">
