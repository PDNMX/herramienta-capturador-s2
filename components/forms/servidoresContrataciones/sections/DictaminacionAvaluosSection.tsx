          ...
          {responsabilidades.map((resp) => (
            <div key={resp.id} className="p-4 rounded-lg border-2 border-primary/20 bg-card/50">
              ...
              {resp.id === 4 ? (
                ...
                <FormField
                  control={form.control}
                  name={`dictaminacionAvaluos.0.responsabilidades.${resp.id - 1}.elaborar`}
                  render={({ field }) => (
                ...
                <FormField
                  control={form.control}
                  name={`dictaminacionAvaluos.0.responsabilidades.${resp.id - 1}.revisar`}
                  render={({ field }) => (
                    <div className="flex items-center space-x-2">
                      <Checkbox
                ...
                <FormField
                  control={form.control}
                  name={`dictaminacionAvaluos.0.responsabilidades.${resp.id - 1}.firmarAutorizar`}
                  render={({ field }) => (
                    <div className="flex items-center space-x-2">
                      <Checkbox
                ...
                <FormField
                  control={form.control}
                  name={`dictaminacionAvaluos.0.responsabilidades.${resp.id - 1}.supervisar`}
                  render={({ field }) => (
                    <div className="flex items-center space-x-2">
                      <Checkbox
                ...
                <FormField
                  control={form.control}
                  name={`dictaminacionAvaluos.0.responsabilidades.${resp.id - 1}.emitirSuscribir`}
                  render={({ field }) => (
                    <div className="flex items-center space-x-2">
                      <Checkbox
