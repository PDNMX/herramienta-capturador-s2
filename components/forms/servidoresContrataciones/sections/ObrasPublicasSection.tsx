...
const tiposArea = [
  { value: "AREA_RESPONSABLE_EJECUCION", label: "Área Responsable de la Ejecución de los Trabajos" },
  { value: "AREA_RESPONSABLE_CONTRATACION", label: "Área Responsable de la Contratación" },
  { value: "AREA_TECNICA", label: "Área Técnica" },
  { value: "AREA_REQUIRENTE", label: "Área Requirente" },
  { value: "INTEGRANTE_COMITE", label: "Integrante del Comité de Obras Públicas" },
    ...
    <div className="space-y-8">
      ...
      <div className="p-6 bg-blue-50/50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-700">
        <h4 className="text-sm font-semibold mb-4 text-blue-900 dark:text-blue-100">
          Tipo de Área <span className="text-xs text-muted-foreground">(Esta sección se actualizará quincenalmente)</span>
        </h4>
        ...
        <div className="space-y-6 p-6 rounded-lg border-2 border-primary/20 bg-card/50">
                ...
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} value={field.value} disabled={loading}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="SERVICIOS_RELACIONADOS">Servicios Relacionados con Obra Pública</SelectItem>
                      <SelectItem value="OTRO">Otro (Especifique)</SelectItem>
                    </SelectContent>
                  </Select>
                  <FormMessage />
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-sm font-semibold">
                  ¿La persona servidora pública continúa participando en los procedimientos de contratación de obra pública y los servicios relacionados con la misma? <span className="text-red-500">*</span>
                </FormLabel>
                ...
                <div className="flex items-center space-x-6">
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      disabled={loading}
                    />
                    <Label htmlFor="continua-obra-si" className="text-sm font-normal cursor-pointer">
                      Sí
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      disabled={loading}
                    />
                    <Label htmlFor="continua-obra-no" className="text-sm font-normal cursor-pointer">
                      No
                    </Label>
                  </div>
                </div>
