    ...
    <main className="relative gradient-background min-h-screen flex flex-col items-center justify-start md:justify-center">
      <div className="container relative mx-auto px-3 md:px-4 pt-1 flex flex-col items-center">
        ...
        <Dialog open={isInstructionsModalOpen} onOpenChange={setIsInstructionsModalOpen}>
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto rounded-md">
            <DialogHeader>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-blue-50/80 dark:bg-blue-900/20 rounded-xl p-4 border border-blue-200/50 dark:border-blue-700/30">
                <p className="text-sm md:text-base text-blue-800 dark:text-blue-200 text-center">
              ...
              <div className="grid gap-4 md:gap-5 lg:grid-cols-2">
                {/* Podrás denunciar */}
                <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm p-4 md:p-5 rounded-2xl shadow-lg">
