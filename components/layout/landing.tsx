...
export default function Landing() {
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-4">
      ...
      <div
        className="absolute bottom-0 left-1/4 -z-10 h-[350px] w-[350px] rounded-full bg-primary/20 blur-[120px] animate-pulse-glow"
        style={{ animationDelay: "1s" }}
      />
      <div
        className="absolute top-1/4 right-1/4 -z-10 h-[250px] w-[250px] rounded-full bg-primary/15 blur-[100px] animate-pulse-glow"
      ...
      <div className="mx-auto max-w-5xl text-center">
        ...
        <div className="mb-12 inline-flex items-center justify-center animate-float">
          <div className="relative">
            ...
            <div
              className="absolute inset-0 animate-ping rounded-full bg-primary/20 blur-xl"
              style={{ animationDuration: "3s" }}
            />
            <div
              className="absolute inset-0 animate-pulse rounded-full bg-primary/30 blur-2xl"
              style={{ animationDuration: "4s" }}
            />

            {/* Círculo exterior giratorio */}
            <div
              className="absolute -inset-4 rounded-full border-2 border-dashed border-primary/90 animate-spin"
            ...
            <div className="relative flex h-36 w-36 items-center justify-center rounded-full border-4 border-primary/40 bg-gradient-to-br from-primary/30 via-primary/10 to-transparent shadow-2xl shadow-primary/40">
              ...
              <div className="absolute inset-0 rounded-full from-transparent via-white/10 to-transparent" />
              ...
              <div
                className="absolute bottom-1/3 left-1/3 h-1.5 w-1.5 rounded-full bg-white/60 blur-sm animate-pulse"
                style={{ animationDelay: "1s" }}
              />
            </div>
          </div>
        ...
        <h1 className="text-balance font-sans text-5xl font-bold tracking-tight text-foreground md:text-6xl lg:text-7xl">
          <span className="relative inline-block">
            <span className="bg-gradient-to-r from-foreground via-primary to-foreground bg-clip-text text-transparent animate-shimmer bg-[length:200%_auto]">
              Sistema de los servidores públicos
            </span>
          ...
          <span className="relative inline-block text-4xl md:text-5xl lg:text-6xl mt-2">
            <span className="bg-gradient-to-r from-foreground/90 via-primary/90 to-foreground/90 bg-clip-text text-transparent">
              que intervengan en procedimientos
            </span>
          </span>
          <br />
          <span className="relative inline-block text-4xl md:text-5xl lg:text-6xl mt-2">
        ...
        <div
          className="absolute top-1/4 left-1/4 h-2 w-2 rounded-full bg-primary/30 blur-sm animate-pulse"
          style={{ animationDelay: "0.5s" }}
        />
        <div
          className="absolute top-1/3 right-1/3 h-1.5 w-1.5 rounded-full bg-primary/25 blur-sm animate-pulse"
          style={{ animationDelay: "1.5s" }}
        />
        <div
          className="absolute bottom-1/4 right-1/4 h-2 w-2 rounded-full bg-primary/30 blur-sm animate-pulse"
          style={{ animationDelay: "2.5s" }}
        />
        <div
          className="absolute bottom-1/3 left-1/3 h-1.5 w-1.5 rounded-full bg-primary/25 blur-sm animate-pulse"
